...
from util.LoggerUtils import get_logger
from util.MySqlUtils import add, connect
...
# 获取未打卡学生信息
def get_daka(image_path):
    logger = get_logger('get_daka', )
    # 解析未打卡信息
...
if __name__ == '__main__':
    get_daka('./image/打卡/20201207-2.jpeg')
